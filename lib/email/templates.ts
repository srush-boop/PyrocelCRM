...
export interface EmailData {
  ...
  reportUrl?: string
  // Public link to the site's fire safety log book (included on every report).
  logbookUrl?: string
...
// A prompt linking to the site's digital fire safety log book. Included on
// every report so occupiers always have one place to find their records.
