...
// Streams a private call attachment to authenticated staff. The row is looked
// up by id so we never trust a client-supplied blob path directly.
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('[v0] Task attachment serve error:', error)
