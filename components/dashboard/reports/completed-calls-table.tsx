...
interface CompletedCallsTableProps {
  /**
   * When true the component is embedded inside another page (the All Calls →
   * Completed tab), so it drops its own page title and outer vertical spacing.
   */
  embedded?: boolean
}

export function CompletedCallsTable({ embedded = false }: CompletedCallsTableProps) {
