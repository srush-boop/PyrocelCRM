...
import type { ChargeTemplate } from '@/lib/types/database'
...
export function ChargeTemplatesSettings({ chargeTemplates }: ChargeTemplatesSettingsProps) {
  ...
  function openEdit(t: ChargeTemplate) {
    setForm({
      ...
      nominalCode: t.default_nominal_code ?? '',
      active: t.active,
    })
    setMessage(null)
    setDialogOpen(true)
  ...
  function handleSave() {
    ...
    const payload = {
      ...
      defaultNominalCode: form.nominalCode,
      active: form.active,
    }
