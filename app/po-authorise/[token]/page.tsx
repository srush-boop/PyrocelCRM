...
export default function PoAuthorisePage() {
  ...
  const companyName = process.env.NEXT_PUBLIC_COMPANY_NAME || 'Pyrocel'
    ...
    <div className="min-h-screen bg-muted/40 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="bg-foreground px-8 py-6">
          ...
          <p className="text-muted text-sm mt-1">Purchase Order Authorisation</p>
        </div>
